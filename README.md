...
# FreeFactoryQT
<img width="1110" height="777" alt="image" src="https://github.com/user-attachments/assets/ecf6324d-6c7a-4461-9433-5fa9169e3fa8" />
...
## What's New
 - 2026-06-27 Added **Timecode Mode** and **Start Timecode** controls to the **Advanced Video** tab. Timecode Mode provides three options: **Default**, **DF (Drop Frame)**, and **NDF (Non-Drop Frame)**. Selecting DF or NDF automatically formats the Start Timecode field using the appropriate separator (semicolon or colon) and allows the starting timecode to be customized.
...
- ✅ Rewrite `FreeFactoryConversion.tcl` in Python (as of 2025-08-22 this has been completed). FreeFactoryConversion.tcl is now officially broken. 
...
- 🪟 **In Progress:** Add a new commandline tool called *freefactory*. This will run factories using *freefactory -factory /factorypath/name filename*. This will allow scripting or cron jobs for executing a factory job. You can even add to your Linux Menu Actions potentially, which is really the point of this ;). No UI needed once the factory exists.
