...
# System Control variables
	global PPref screenx screeny passconfig SystemTime FreeFactoryInstallType WindowSizeX WindowSizeY FontSizeLabel FontSizeText
...
# Video and Audio variables
	...
	global ManualOptions CommandLine
	...
	global ManualOptionsTmp CommandLineTmp
...
# placement.
	set xCord [expr int(($screenx-960)/2)]
	set yCord [expr int(($screeny-580)/2)]
##########################################################################################################################
##########################################################################################################################
    ...
    wm geometry $top 990x580+$xCord+$yCord; update
    wm maxsize $top 960 580
    wm minsize $top 960 580
...
#		FillLogList
	...
	button $site_4_0.newButton -command {
		InitVariables
		focus .programFrontEnd.middleFrame.factorySelection.childsite.selectedFactoryEntry.lwchildsite.entry
	} -borderwidth 0 -image [vTcl:image:get_image [file join / opt FreeFactory Pics New-32x32.gif]] -text ""
	...
	button $site_4_0.saveButton -borderwidth 0 -image [vTcl:image:get_image [file join / opt FreeFactory Pics SaveAs-32x32.gif]] \
	-command {
		if {[file exists "/opt/FreeFactory/Factories/$SelectedFactory"]} {
			if {$PPref(ConfirmFileSaves) == "Yes"} {
				set GenericConfirm 2
	...
	button $site_4_0.deleteButton -borderwidth 0 -image [vTcl:image:get_image [file join / opt FreeFactory Pics Remove-32x32.gif]] \
	...
	button $site_4_0.exitButton -borderwidth 0 -image [vTcl:image:get_image [file join / opt FreeFactory Pics Exit-32x32.gif]] \
	-command {
		exit
	} -text ""
	...
	button $site_4_4.editSettingsButton -borderwidth 0 -image [vTcl:image:get_image [file join / opt FreeFactory Pics Ksysguard-32x32.gif]] \
	-command {
		set SettingsCancelConfirm ""
		source "/opt/FreeFactory/bin/Settings.tcl"
		Window show .settings
	...
	button $site_4_4.saveSettingsButton -borderwidth 0 -image [vTcl:image:get_image [file join / opt FreeFactory Pics SaveAs-32x32.gif]] \
	-command {
		if {$PPref(ConfirmFileSaves) == "Yes"} {
			set GenericConfirm 2
			Window show .genericConfirm
	...
	button $site_4_6.helpButton -borderwidth 0 -highlightthickness 0 -image [vTcl:image:get_image [file join / opt FreeFactory Pics Help_Index3-2x32.gif]] \
...
#						set FTPPasswordEntry $DecodedPassword
						...
						"MANUALOPTIONS" {set ManualOptions $FactoryValue}
...
# Reload list box
	...
	-command {
		...
		set buttonImagePathFileDialog [vTcl:image:get_image [file join / opt FreeFactory Pics Open-32x32.gif]]
		widgetUpdate
		initDirectoryDialog
	...
	} -foreground black -highlightcolor black -image [vTcl:image:get_image [file join / opt FreeFactory Pics Open-32x32.gif]] -text ""
	...
	::iwidgets::entryfield $site_6_0_3.vStreamIDsEntry -width 7 -labelpos w -labeltext "Stream ID" -textvariable VideoStreamID -command {ViewCommandLine}
	...
	::iwidgets::entryfield $site_6_0_3.bFramesEntry -width 7 -labelpos w -labeltext "B Frames" -textvariable BFramesEntry -command {ViewCommandLine}
	...
	::iwidgets::entryfield $site_6_0_3.frameStrategyEntry -width 7 -labelpos w -labeltext "Frame Strategy" -textvariable FrameStrategyEntry -command {ViewCommandLine}
	...
	::iwidgets::entryfield $site_6_0_3.groupPicSizeEntry -width 7 -labelpos w -labeltext "Group Pic Size" -textvariable GroupPicSizeEntry -command {ViewCommandLine}
	...
	::iwidgets::entryfield $site_6_0_3.startTimeOffsetEntry -width 7 -labelpos w -labeltext "Start Time Offset" -textvariable StartTimeOffsetEntry -command {ViewCommandLine}
	...
	::iwidgets::entryfield $site_6_1.audioStreamIDEntry -width 7 -labelpos w -labeltext "Stream ID" -textvariable AudioStreamID -command {ViewCommandLine}
	...
	} -image [vTcl:image:get_image [file join / opt FreeFactory Pics Message-32x32.gif]]
...
# 	} -image [vTcl:image:get_image [file join / opt FreeFactory Pics New-32x32.gif]]
...
# Load the list box with factory emails.
	...
	} -image [vTcl:image:get_image [file join / opt FreeFactory Pics AddEMailUser-32x32.gif]]
...
# Load the list box with factory emails.
		...
		ButtonUpdateEMail configure -state disable
		ButtonRemoveEMail configure -state disable
	} -image [vTcl:image:get_image [file join / opt FreeFactory Pics Update-32x32.gif]]
...
# Load the list box with linked factories.
		...
		ButtonUpdateEMail configure -state disable
		ButtonRemoveEMail configure -state disable
	} -image [vTcl:image:get_image [file join / opt FreeFactory Pics RemoveEMailUser-32x32.gif]]
...
# Load the list box with linked factories.
		...
		ButtonAddLink configure -state disable
	} -image [vTcl:image:get_image [file join / opt FreeFactory Pics AddFactoryLink-32x32.gif]]
...
# Load the list box with linked factories.
		...
		ButtonRemoveLink configure -state disable
	} -image [vTcl:image:get_image [file join / opt FreeFactory Pics RemoveFactoryLink-32x32.gif]]
	...
	::iwidgets::entryfield $site_5_2.viewCommandLine -width 7 -labelpos n -labeltext "Command Line" -textvariable CommandLine
	vTcl:DefineAlias "$site_5_2.viewCommandLine" "EntryViewCommandLine" vTcl:WidgetProc "Toplevel1" 1
	set BindWidget "$site_5_2.viewCommandLine.lwchildsite.entry"
	vTcl:DefineAlias "$BindWidget" "EntryViewCommandLineChild" vTcl:WidgetProc "Toplevel1" 1
	pack $site_5_2.viewCommandLine -in $site_5_2 -anchor nw -expand 1 -fill x -side bottom
	bind $BindWidgetEntry <FocusIn> {
		if {$PPref(SelectAllText) == "Yes"} {EntryViewCommandLineChild select range 0 end}
		EntryViewCommandLineChild icursor end
	}
        bind $BindWidget <Key-Return> {}
        bind $BindWidget <Key-KP_Enter> {}

	::iwidgets::entryfield $site_5_2.manualOptions -width 7 -labelpos w -labeltext "Manual Options" -textvariable ManualOptions
	vTcl:DefineAlias "$site_5_2.manualOptions" "EntryManualOptions" vTcl:WidgetProc "Toplevel1" 1
	set BindWidget "$site_5_2.manualOptions.lwchildsite.entry"
	vTcl:DefineAlias "$BindWidget" "EntryManualOptionsChild" vTcl:WidgetProc "Toplevel1" 1
	pack $site_5_2.manualOptions -in $site_5_2 -anchor nw -expand 1 -fill x -side bottom
	bind $BindWidgetEntry <FocusIn> {
		if {$PPref(SelectAllText) == "Yes"} {EntryManualOptionsChild select range 0 end}
		EntryManualOptionsChild icursor end
	}
        bind $BindWidget <Key-Return> {}
        bind $BindWidget <Key-KP_Enter> {}
...
#	ComboBoxFFMxProgramFactorySelection insert list end "libav"
	...
	set FileHandle [open /opt/FreeFactory/etc/VideoCodecs r]
	while {![eof $FileHandle]} {
		gets $FileHandle ReadLine
		ComboBoxVideoCodecsFactorySelection insert list end $ReadLine
	}
	close $FileHandle

	ComboBoxVideoWrapperFactorySelection clear
	ComboBoxVideoWrapperFactorySelection insert list end ""
	set FileHandle [open /opt/FreeFactory/etc/VideoWrapper r]
	while {![eof $FileHandle]} {
		gets $FileHandle ReadLine
		ComboBoxVideoWrapperFactorySelection insert list end $ReadLine
	}
	close $FileHandle

	ComboBoxFrameRateFactorySelection clear
	ComboBoxFrameRateFactorySelection insert list end ""
	set FileHandle [open /opt/FreeFactory/etc/FrameRate r]
	while {![eof $FileHandle]} {
		gets $FileHandle ReadLine
		ComboBoxFrameRateFactorySelection insert list end $ReadLine
	}
	close $FileHandle

	ComboBoxSizeFactorySelection clear
	ComboBoxSizeFactorySelection insert list end ""
	set FileHandle [open /opt/FreeFactory/etc/VideoSizes r]
	while {![eof $FileHandle]} {
		gets $FileHandle ReadLine
			ComboBoxSizeFactorySelection insert list end $ReadLine
	}
	close $FileHandle

	ComboBoxTargetFactorySelection clear
	ComboBoxTargetFactorySelection insert list end ""
	set FileHandle [open /opt/FreeFactory/etc/Target r]
	while {![eof $FileHandle]} {
		gets $FileHandle ReadLine
			ComboBoxTargetFactorySelection insert list end $ReadLine
	}
	close $FileHandle
	...
	ComboBoxThreadsFactorySelection insert list end "16"
	ComboBoxThreadsFactorySelection insert list end "20"
	ComboBoxThreadsFactorySelection insert list end "24"
	ComboBoxThreadsFactorySelection insert list end "28"
	ComboBoxThreadsFactorySelection insert list end "32"
	...
	set FileHandle [open /opt/FreeFactory/etc/AudioCodecs r]
	while {![eof $FileHandle]} {
		gets $FileHandle ReadLine
			ComboBoxAudioCodecsFactorySelection insert list end $ReadLine
	}
	close $FileHandle
	...
	set FileHandle [open /opt/FreeFactory/etc/AudioSampleRate r]
	while {![eof $FileHandle]} {
		gets $FileHandle ReadLine
			ComboBoxAudioSampleRateFactorySelection insert list end $ReadLine
	}
	close $FileHandle

	ComboBoxAudioFileExtensionFactorySelection clear
	ComboBoxAudioFileExtensionFactorySelection insert list end ""
	set FileHandle [open /opt/FreeFactory/etc/AudioFileExtensions r]
	while {![eof $FileHandle]} {
		gets $FileHandle ReadLine
			ComboBoxAudioFileExtensionFactorySelection insert list end $ReadLine
	}
	close $FileHandle
...
# Video and Audio variables
	...
	global ManualOptionsTmp CommandLineTmp
		...
		set AudioChannelsTmp $AudioChannels
		set AudioStreamIDTmp $AudioStreamID
		set ManualOptionsTmp $ManualOptions
		set CommandLineTmp $CommandLine
		set DeleteSourceTmp $DeleteSource
		set DeleteConversionLogsTmp $DeleteConversionLogs
		set EnableFactoryTmp $EnableFactory
		set FreeFactoryActionTmp $FreeFactoryAction
...
#	puts $FileHandle "FTPPASSWORD=[string trim $EncodedPassword]"
	...
	puts $FileHandle "MANUALOPTIONS=[string trim $ManualOptions]"
...
# Free Factory variables
	...
	set CommandLine $FFMxProgram

	if {[string trim $VideoCodecs] != ""} {
		append CommandLine "-c:v "
		append CommandLine "$VideoCodecs "
	}
	if {[string trim $VideoWrapper] != ""} {
		append CommandLine "$VideoWrapper "
	}
	if {[string trim $VideoFrameRate] != ""} {
		append CommandLine "-r "
		append CommandLine "$VideoFrameRate "
	}
	if {[string trim $VideoSize] != ""} {
		append CommandLine "-s "
		append CommandLine "$VideoSize "
	}
	if {[string trim $VideoTarget] != ""} {
		append CommandLine "-target "
		append CommandLine "$VideoTarget "
	}
	if {[string trim $VideoTags] != ""} {
		append CommandLine "-vtag "
		append CommandLine "$VideoTags "
	}
	if {[string trim $Threads] != ""} {
		append CommandLine "-threads "
		append CommandLine "$Threads "
	}
	if {[string trim $Aspect] != ""} {
		append CommandLine "-aspect "
		append CommandLine "$Aspect "
	}
	if {[string trim $VideoBitRate] != ""} {
		append CommandLine "-b:v "
		append CommandLine "$VideoBitRate "
	}
	if {[string trim $VideoPreset] != ""} {
		append CommandLine "-vpre "
		append CommandLine "$VideoPreset "
	}
	if {[string trim $VideoStreamID] != ""} {
		append CommandLine "-map "
		append CommandLine "$VideoStreamID "
	}
	if {[string trim $GroupPicSizeEntry] != ""} {
		append CommandLine "-g "
		append CommandLine "$GroupPicSizeEntry "
	}
	if {[string trim $BFramesEntry] != ""} {
		append CommandLine "-bf "
		append CommandLine "$BFramesEntry "
	}
	if {[string trim $FrameStrategyEntry] != ""} {
		append CommandLine "-b_strategy "
		append CommandLine "$FrameStrategyEntry "
	}
	if {[string trim $ForceFormat] != ""} {
		append CommandLine "-f "
		append CommandLine "$ForceFormat "
	}
	if {[string trim $StartTimeOffsetEntry] != ""} {
		append CommandLine "-ss "
		append CommandLine "$StartTimeOffsetEntry "
	}
	if {[string trim $AudioCodecs] != ""} {
		append CommandLine "-c:a "
		append CommandLine "$AudioCodecs "
	}
	if {[string trim $AudioBitRate] != ""} {
		append CommandLine "-b:a "
		append CommandLine "$AudioBitRate "
	}
	if {[string trim $AudioSampleRate] != ""} {
		append CommandLine "-ar "
		append CommandLine "$AudioSampleRate "
	}
	if {[string trim $AudioFileExtension] != ""} {
		append OutputFileName $AudioFileExtension
	}
	if {[string trim $AudioTag] != ""} {
		append CommandLine "-atag "
		append CommandLine "$AudioTag "
	}
	if {[string trim $AudioChannels] != ""} {
		append CommandLine "-ac "
		append CommandLine "$AudioChannels "
	}
	if {[string trim $AudioStreamID] != ""} {
		append CommandLine "-map "
		append CommandLine "$AudioStreamID "
	}
	if {[string trim $ManualOptions] != ""} {
		append CommandLine "$ManualOptions "
	}
}
